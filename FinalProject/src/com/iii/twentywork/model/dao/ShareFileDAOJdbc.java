...
public class ShareFileDAOJdbc implements Serializable, ShareFileDAO
{
    ...
    {
        String connUrl = "jdbc:sqlserver://localhost:1433;databaseName=TwentyWork_";
...
//            stmt.setInt(7, bean.getUpperFolderId());
    ...
    {//testing#11
        ...
        try
        {
            ...
            while(rs.next()) {
                FileTreeBean bean = new FileTreeBean();
...
//        System.out.println(dao.copyFile(dao.selectByFileId(20), 9));//testing#10
        ...
        List<FileTreeBean> rs2 = dao.getGroupFolderTree(201);
        for(Iterator<FileTreeBean> item=rs2.iterator();item.hasNext(); ) {
            System.out.println(item.next());
        }//testing#11
