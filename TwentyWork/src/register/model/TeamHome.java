...
public class TeamHome
{
    ...
    public Team merge(Team detachedInstance)
    {
        ...
        try
        {
            Team result = (Team) sessionFactory.getCurrentSession()
    ...
    public Team findById(int id)
    {
        ...
        try
        {
            Team instance = (Team) sessionFactory.getCurrentSession()
                    .get("register.model.Team", id);
            if (instance == null)
            {
    ...
    public List<Team> findByExample(Team instance)
    {
        ...
        try
        {
            List<Team> results = (List<Team>) sessionFactory.getCurrentSession()
                    .createCriteria("register.model.Team").add(create(instance))
                    .list();
